...
const REPORT_FAQS = [
  ...
  },
  {
    ...
    answer:
      "A compliant report includes expert qualifications and methodology, sources, applicable human rights standards, country conditions for the specific profile, violation severity analysis, return risk opinion where applicable, and a statement of truth with declaration of independence.",
  },
];
