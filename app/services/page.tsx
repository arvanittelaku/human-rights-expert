...
export const metadata = createMetadata({
  ...
  description:
    "Human rights expert witness services: country condition reports, Article 3 deportation risk, torture analysis, arbitrary detention, HR defender risk, women's rights, LGBT rights, and rule of law reports.",
  path: "/services",
});
