...
export const caseTypes: CaseType[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Expert evidence in Upper Tribunal work addresses leading authority on Article 3 non-refoulement including Soering v UK [1989], Chahal v UK [1996], AAA (Somalia) [2023] UKSC, and DD (Afghanistan) [2024] UKSC. Reports must demonstrate independence, objectivity, and primary duty to the tribunal.",
  ...
  },
  {
    ...
    metaDescription:
      "Human rights expert reports for Article 3 ECHR deportation and removal cases. Real risk of torture, inhuman or degrading treatment, AAA Somalia, and DD Afghanistan analysis.",
    ...
    content: [
      ...
      "Human rights experts assess country conditions, the appellant's individual profile, documented violation patterns, and whether internal relocation provides protection from Article 3 harm. Leading authority including AAA (Somalia) [2023] UKSC on failed asylum returnees and DD (Afghanistan) [2024] UKSC on Taliban return informs current expert analysis.",
    ...
    faqs: [
      {
        ...
        answer:
          "The real risk test requires assessment of whether substantial grounds exist for believing the individual would face a real risk of torture or inhuman or degrading treatment on return. Experts analyse country conditions, individual profile, and documented violation patterns against Soering and Chahal standards.",
      },
      {
        question: "How does AAA (Somalia) [2023] affect expert evidence in removal cases?",
        answer:
          "AAA established that failed asylum seekers returning to Somalia may face enhanced risk based on diaspora profile and lack of clan protection. Human rights experts assess whether similar principles apply to the appellant's country and profile, analysing returnee risk beyond general country conditions.",
      },
    ],
  ...
  },
  {
    ...
    metaDescription:
      "Human rights expert reports supporting Article 8 ECHR family and private life claims. Country conditions, risk on return, and human rights context for UK immigration tribunals.",
    ...
    content: [
      ...
      "Experts may be instructed to provide country conditions analysis relevant to Article 8 claims, including human rights context for family members remaining in the country of origin, risk to children, and conditions that would affect the quality of family or private life on return.",
      "Human rights experts complement immigration lawyers in Article 8 proceedings by providing independent analysis of country conditions and human rights standards that inform the tribunal's proportionality assessment under Razgar [2004] UKHL 27.",
    ],
    faqs: [
      {
        question: "When is a human rights expert relevant to Article 8 claims?",
        answer:
          "Where return conditions engage human rights violations affecting family members, children, or the appellant's private life. Experts provide country conditions and human rights context that informs the proportionality balancing exercise, particularly where conditions in the country of origin are contested.",
      },
      {
        question: "Can human rights experts address medical conditions in Article 8 cases?",
        answer:
          "Human rights experts address country conditions affecting health and medical treatment availability, complementing medical expert evidence. Paposhvili and Savran principles may engage both Article 3 and Article 8 analysis where medical conditions affect quality of life on return.",
      },
    ],
  ...
  },
  {
    ...
    metaDescription:
      "Human rights expert reports for fresh human rights claims and further submissions. Updated country conditions, new violation evidence, and return risk analysis.",
    h1: "Human Rights Expert for Fresh Human Rights Claims",
    content: [
      "Fresh human rights claims require evidence that was not previously considered and is capable of giving rise to a realistic prospect of success. Human rights expert reports provide updated country conditions analysis, new violation evidence, and return risk assessment that supports further submissions under paragraph 353 of the Immigration Rules.",
      "Experts address changes in country conditions since the original decision, new treaty body reports, updated CPIN human rights sections, and emerging violation patterns such as shrinking civic space or digital surveillance targeting. Reports must clearly identify what is new and why it changes the risk assessment.",
    ...
    faqs: [
      {
        ...
        answer:
          "Evidence must be new, capable of giving rise to a realistic prospect of success, and not merely a reargument of previously rejected material. Updated treaty body reports, changed country conditions, new violation patterns, or expert analysis of human rights standards not previously considered may satisfy these requirements.",
      },
      {
  ...
  },
  {
    ...
    content: [
      "Human rights defender asylum claims require expert analysis of whether the appellant's activist, journalist, or NGO profile creates specific return risk in countries with shrinking civic space. The UN Declaration on Human Rights Defenders and Special Rapporteur reports provide the international standards framework.",
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Past torture is a significant factor but experts must assess whether return would expose the appellant to a real risk of further ill-treatment based on current country conditions, perpetrator identity, impunity, and individual targeting risk.",
      },
    ],
    ...
    faqs: [
      {
        ...
        answer:
          "Human rights experts analyse healthcare conditions, treatment availability, and discrimination in the country of origin. They complement medical experts by providing country conditions context for whether inadequate treatment would reach the Article 3 threshold under Paposhvili and Savran standards.",
      },
      {
        question: "Do human rights experts provide medical diagnoses?",
        answer:
          "No. Human rights experts analyse country conditions and human rights standards. Medical diagnoses and treatment opinions are provided by medical experts. Human rights experts address whether conditions in the country of origin engage Article 3 through inadequate healthcare.",
      },
    ],
