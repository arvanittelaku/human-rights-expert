...
export const guides: Guide[] = [
 ...
 metaDescription:
      "Complete solicitor's guide to Article 3 ECHR deportation cases: Soering, Chahal, real risk test, AAA [2023] UKSC, DD [2024] UKSC, and expert evidence requirements.",
 ...
 content: [
 "Early instruction improves report quality and tribunal acceptance. Identify the human rights issue: violation type, Article 3 risk, or treaty standard requiring expert analysis. Determine whether a human rights framework expert, supplementary specialist, or both are needed.",
 "The letter of instruction should follow Adam Pipe October 2025 guidance: identify proceedings, funding, specific questions, appellant profile, documents provided, and deadline. Provide witness statements, Home Office decision, CPIN, medical reports, and relevant policy documentation.",
 ...
 answer:
 "Witness statements, Home Office decision and reasons, CPIN, medical reports, relevant policy documentation, previous expert reports, and tribunal directions. A clear letter of instruction identifying specific questions is essential.",
 },
 {
