...
export const services: Service[] = [
  {
    ...
    name: "Human Rights Country Condition Reports",
    description:
      "Independent analysis of human rights conditions in the country of origin, applying ICCPR, CAT, CEDAW, and ECHR treaty standards to the appellant's specific profile for tribunal proceedings.",
    metaTitle: "Human Rights Country Condition Reports UK | Expert Witness",
    metaDescription:
      "Human rights country condition expert reports for UK immigration tribunals. ICCPR, CAT, CEDAW, ECHR standards applied to the appellant's profile and return risk.",
    h1: "Human Rights Country Condition Reports UK",
    content: [
      "Human rights country condition reports provide independent analysis of the human rights situation in the appellant's country of origin, applying international treaty standards rather than reproducing Home Office CPIN summaries alone. Experts assess ICCPR, CAT, CEDAW, ICERD, and ECHR benchmarks against documented state practice.",
      "Reports address country conditions relevant to the specific appellant profile: journalists, activists, religious minorities, women, LGBT individuals, torture survivors, and failed asylum returnees. Experts synthesise treaty body reports, OHCHR documentation, NGO sources, and tribunal country guidance.",
      "Country condition reports comply with Immigration Tribunal Practice Direction 2024 and the Adam Pipe October 2025 expert report guide. They may be instructed alongside country-specific experts where detailed local conditions evidence is also required.",
    ],
    faqs: [
      {
        question: "When should I instruct a human rights country condition expert?",
        answer:
      ...
      {
        question: "How do human rights country reports differ from CPINs?",
        answer:
          "CPINs provide Home Office country information. Human rights experts apply independent treaty body standards, NGO documentation, and field research to assess violation severity and return risk for the specific appellant profile.",
      },
    ],
  },
  {
    ...
    description:
      "Expert assessment of real risk of torture, inhuman or degrading treatment on return for deportation and removal cases, applying Soering, Chahal, AAA, and DD Afghanistan jurisprudence.",
    metaTitle: "Article 3 Deportation Risk Expert Reports UK",
    metaDescription:
      "Article 3 ECHR deportation risk expert reports for UK removal cases. Soering, Chahal, AAA Somalia, DD Afghanistan, and real risk analysis for immigration tribunals.",
    h1: "Article 3 Deportation Risk Expert Reports UK",
    content: [
      "Article 3 deportation risk reports assess whether removal would expose the appellant to a real risk of torture, inhuman or degrading treatment. The Soering standard and anxious scrutiny apply, requiring careful analysis of country conditions and individual profile.",
      "Experts apply leading authority including Chahal v UK [1996], AAA (Somalia) [2023] UKSC on failed asylum returnees, and DD (Afghanistan) [2024] UKSC on Taliban return conditions. Reports address internal relocation viability and medical conditions where Paposhvili and Savran engage.",
    ...
    faqs: [
      {
        ...
        answer:
          "Substantial grounds must exist for believing the individual would face torture or inhuman treatment on return. Experts analyse country conditions, individual profile, and documented violation patterns against Soering and Chahal standards.",
      },
      {
        question: "How does AAA (Somalia) [2023] affect deportation expert evidence?",
        answer:
          "AAA established enhanced return risk for failed asylum seekers without clan protection. Experts assess whether similar diaspora profile and lack of support network principles apply to the appellant's country and circumstances.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      "Experts analyse torture patterns in the country of origin, state versus non-state perpetrators, impunity, detention conditions, and whether the appellant's profile creates specific targeting risk. Medical evidence is interfaced using Istanbul Protocol documentation standards without providing medical diagnoses.",
      "Reports address torture survivor claims, Article 3 deportation proceedings, and fresh claims where updated torture documentation or changed country conditions affect return risk assessment.",
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Experts analyse country-specific disappearance patterns, state practice, whether the appellant's profile creates targeting risk, and whether return would expose them to disappearance or further arbitrary detention.",
      },
    ],
  },
  {
    ...
    description:
      "Specialist assessment of return risk for journalists, activists, and human rights defenders in countries with shrinking civic space and diaspora monitoring.",
    ...
    content: [
      "Human rights defender risk assessments analyse whether the appellant's activist, journalist, or NGO profile creates specific return risk in countries with shrinking civic space. The UN Declaration on Human Rights Defenders provides the international standards framework.",
    ...
    faqs: [
      {
        ...
        answer:
          "HR defenders, journalists, and activists face enhanced targeting in countries with shrinking civic space. Experts assess whether the appellant's defender profile creates specific return risk beyond general country conditions.",
      },
      {
  ...
  },
  {
    ...
    metaTitle: "LGBT Human Rights Expert Reports UK | All Countries",
    metaDescription:
    ...
    content: [
      ...
      "Thematic LGBT human rights experts provide analysis across countries while country-specific experts may supplement for detailed local conditions evidence in complex claims.",
    ],
    faqs: [
      {
      ...
      {
        question: "Can a human rights expert cover LGBT claims from multiple countries?",
        answer:
          "Yes. Human rights experts specialising in LGBT rights provide thematic analysis across jurisdictions. Country-specific experts may supplement for detailed local conditions.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      "Reports draw on UN rule of law indicators, treaty body concluding observations, and NGO documentation on judicial independence and institutional reform failures in the country of origin.",
    ],
    faqs: [
      {
