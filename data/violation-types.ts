...
export const violationTypes: ViolationType[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Enforced disappearance involves detention followed by refusal to acknowledge deprivation of liberty. Experts analyse country-specific patterns, state practice, whether the appellant's profile creates targeting risk, and whether return would expose them to disappearance or further arbitrary detention.",
      },
    ],
  ...
  },
  {
    ...
    metaTitle: "LGBT Human Rights Expert Witness UK | All Countries",
    metaDescription:
    ...
    h1: "LGBT Human Rights Expert Witness UK | All Countries",
    content: [
      ...
      "Human rights experts specialising in LGBT rights can cover claims from multiple countries, providing the overarching human rights framework while country-specific experts may supplement for detailed local conditions. Reports address state tolerance of violence, police harassment, and community hostility as human rights violations distinct from ordinary criminal violence.",
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          "Yes. Human rights experts specialising in LGBT rights provide thematic analysis across jurisdictions, covering criminalisation, enforcement, social hostility, and internal relocation viability. Country-specific experts may supplement for detailed local conditions.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      "Human rights defenders, journalists, and activists face enhanced targeting in countries with shrinking civic space. The UN Declaration on Human Rights Defenders establishes standards for state protection of those who promote and protect human rights. Expert witnesses assess whether the appellant's defender profile creates specific return risk beyond general country conditions.",
    ...
    faqs: [
      {
        ...
        answer:
          "HR defenders, journalists, and activists face enhanced targeting in countries with shrinking civic space. UN Special Rapporteur reports document systematic reprisals. Experts assess whether the appellant's defender profile creates specific return risk beyond general country conditions.",
      },
      {
  ...
  },
  {
    ...
    content: [
      ...
      "Return risk assessment addresses whether the appellant faces a real risk of extrajudicial killing based on their profile and whether the state is unable or unwilling to protect. Reports reference UN Special Rapporteur on extrajudicial executions reports, OHCHR documentation, and country-specific patterns of state violence updated in Home Office CPINs during 2025.",
    ],
    faqs: [
      {
