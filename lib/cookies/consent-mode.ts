...
/**
 * Google Consent Mode v2 — must run before any Google tag loads.
 * Called from ConsentDefaultsScript (beforeInteractive) and on client mount.
 */
...
/** Push consent updates immediately when the user changes preferences. */
