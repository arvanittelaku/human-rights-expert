...
/**
 * Third-party scripts gated by consent. Nothing loads until the user grants
 * the relevant category (enforced by CookieConsentProvider + syncTrackingScripts).
 */
  ...
  return [
    {
      ...
      load: () => {
        ...
        injectScript("hrex-gtag-js", `https://www.googletagmanager.com/gtag/js?id=${gaId}`);
        const inline = document.createElement("script");
        inline.id = "hrex-gtag-inline";
        inline.textContent = `
      ...
      unload: () => {
        removeScript("hrex-gtag-js");
        removeScript("hrex-gtag-inline");
    ...
    },
    {
      ...
      load: () => {
        ...
        const inline = document.createElement("script");
        inline.id = "hrex-linkedin-insight";
        inline.textContent = `
        ...
        `;
        document.head.appendChild(inline);
        injectScript("hrex-linkedin-js", "https://snap.licdn.com/li.lms-analytics/insight.min.js");
        loadedScripts.add("linkedin-insight");
      },
      unload: () => {
        removeScript("hrex-linkedin-insight");
        removeScript("hrex-linkedin-js");
...
/** Load or unload scripts based on current consent choices. */
